...
This project explores how an AI assistant can sit on top of those scattered requirements and help testers:

Ingest requirements, SOPs, and user stories in one place

Ask questions in plain language about flows, rules, and edge cases

Generate structured test ideas that can be exported into existing test management tools

It builds on real experience working in healthcare QA and experimenting with internal GPT-style tools to support testers who are responsible for quality but don’t always control the upstream documentation.